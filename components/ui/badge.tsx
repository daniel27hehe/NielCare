  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        done: "border-transparent bg-slate-100 text-slate-600",
        cancelled: "border-transparent bg-gray-100 text-gray-600",
        critical: "border-transparent bg-red-100 text-red-700 animate-pulse",
        moderate: "border-transparent bg-amber-100 text-amber-700",
        routine: "border-transparent bg-green-100 text-green-700",
      },
    },
    defaultVariants: {
      variant: "default",
